    ...
    <div className="">
      <div className="max-w-6xl mx-auto  mulish">
        ...
        >
          ...
          <p className="mt-2 text-center font-medium mx-auto">
            Explore detailed information about the company including its
            mission, culture, and current <br /> job openings. Get to know the
            organization before taking the next step in your career journey.
          </p>
        </motion.div>
        <motion.div
                    ...
                    <div className=" flex flex-col gap-5" key={job.id}>
                      ...
                      <div>
                        ...
                        <div className="flex justify-between gap-28">
                          ...
                          <Link to={"/"}>
                            <button className=" h-[50px] mt-5 w-full cursor-pointer relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-white transition duration-300 ease-out  rounded-full shadow-md group mb-28">
                              <span className="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 -translate-x-full bg-linear-65 from-blue-400 to-pink-300 group-hover:translate-x-0 ease">
                                <svg
                                  className="w-6 h-6"
                                  fill="none"
                      ...
                      {showModal && (
                        <motion.div
                          ...
                          whileInView="visible"
                          viewport={{ once: true, amount: 0.2 }}
                          className="fixed inset-0  backdrop-blur-md bg-opacity-100 flex items-center justify-center mt-22 z-50 mulish"
                        >
